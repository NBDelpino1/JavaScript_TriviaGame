...
$(document).ready(function(){
    ...
    // Hide Finish Button when page is reloaded so user only has option to start game
    $("#finish").hide();
    $("#results").hide();
...
function finish() {
    ...
    // console.log("You got this many questions right " + correctAnswers);
    // console.log("You got this many questions right " + wrongAnswers);
    document.getElementById("correctNum").innerHTML = "<p>Correct Answers: " + correctAnswers + "</p>"; // display total
    document.getElementById("incorrectNum").innerHTML = "<p>Incorrect Answers: " + wrongAnswers + "</p>"; //display total
}